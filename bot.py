...
class WorkBot:
    def __init__(self):
        ...
        self.bonuses = [
            ...
            "в подарок тряпки",
            "в подарок швабру",
            # Новые смешные бонусы
            "в подарок старую зубную щетку",
            "в подарок ржавый гвоздь",
            "в подарок пустую бутылку",
            "в подарок сломанную лампочку",
            "в подарок старую газету",
            "в подарок пустую коробку",
            "в подарок ржавую шайбу",
            "в подарок старую кнопку",
            "в подарок пустую упаковку",
            "в подарок сломанную зажигалку",
            "в подарок старую резинку",
            "в подарок пустую спичечную коробку",
            "в подарок сломанную ручку",
            "в подарок ржавую скрепку",
            "в подарок старую наклейку",
            "в подарок пустую банку от кофе",
            "в подарок сломанную заколку",
            "в подарок ржавую кнопку от джинсов",
            "в подарок старую наклейку с ценой",
            "в подарок пустую упаковку от жвачки",
            "в подарок сломанную зубочистку",
            "в подарок ржавую скрепку для денег",
            "в подарок старую резинку для волос",
            "в подарок пустую коробку от таблеток",
            "в подарок сломанную заколку для волос",
            "в подарок ржавую кнопку от рубашки",
            "в подарок старую наклейку с адресом",
            "в подарок пустую упаковку от конфет",
            "в подарок сломанную зубочистку для зубов",
            "в подарок ржавую скрепку для документов",
            "в подарок старую резинку для резинки",
            "в подарок пустую коробку от витаминов",
            "в подарок сломанную заколку для заколки",
            "в подарок ржавую кнопку от куртки",
            "в подарок старую наклейку с телефоном",
            "в подарок пустую упаковку от печенья",
            "в подарок сломанную зубочистку для зубочистки",
            "в подарок ржавую скрепку для скрепки",
            "в подарок старую резинку для резинки резинки",
            "в подарок пустую коробку от коробки",
            "в подарок сломанную заколку для заколки заколки",
            "в подарок ржавую кнопку от кнопки",
            "в подарок старую наклейку с наклейкой",
            "в подарок пустую упаковку от упаковки",
            "в подарок сломанную зубочистку для зубочистки зубочистки",
            "в подарок ржавую скрепку для скрепки скрепки",
            "в подарок старую резинку для резинки резинки резинки",
            "в подарок пустую коробку от коробки коробки",
            "в подарок сломанную заколку для заколки заколки заколки",
            "в подарок ржавую кнопку от кнопки кнопки",
            "в подарок старую наклейку с наклейкой наклейкой",
            "в подарок пустую упаковку от упаковки упаковки",
            "в подарок сломанную зубочистку для зубочистки зубочистки зубочистки",
            "в подарок ржавую скрепку для скрепки скрепки скрепки",
            "в подарок старую резинку для резинки резинки резинки резинки",
            "в подарок пустую коробку от коробки коробки коробки",
            "в подарок сломанную заколку для заколки заколки заколки заколки",
            "в подарок ржавую кнопку от кнопки кнопки кнопки",
            "в подарок старую наклейку с наклейкой наклейкой наклейкой",
            "в подарок пустую упаковку от упаковки упаковки упаковки",
            "в подарок сломанную зубочистку для зубочистки зубочистки зубочистки зубочистки",
            "в подарок ржавую скрепку для скрепки скрепки скрепки скрепки",
            "в подарок старую резинку для резинки резинки резинки резинки резинки",
            "в подарок пустую коробку от коробки коробки коробки коробки",
            "в подарок сломанную заколку для заколки заколки заколки заколки заколки",
            "в подарок ржавую кнопку от кнопки кнопки кнопки кнопки",
            "в подарок старую наклейку с наклейкой наклейкой наклейкой наклейкой",
            "в подарок пустую упаковку от упаковки упаковки упаковки упаковки",
            "в подарок сломанную зубочистку для зубочистки зубочистки зубочистки зубочистки зубочистки",
            "в подарок ржавую скрепку для скрепки скрепки скрепки скрепки скрепки",
            "в подарок старую резинку для резинки резинки резинки резинки резинки резинки",
            "в подарок пустую коробку от коробки коробки коробки коробки коробки",
            "в подарок сломанную заколку для заколки заколки заколки заколки заколки заколки",
            "в подарок ржавую кнопку от кнопки кнопки кнопки кнопки кнопки",
            "в подарок старую наклейку с наклейкой наклейкой наклейкой наклейкой наклейкой",
            "в подарок пустую упаковку от упаковки упаковки упаковки упаковки упаковки"
        ]
    ...
    def generate_message(self):
        """Генерирует сообщение в стиле примеров (бесконечная генерация) - УВЕЛИЧЕННАЯ ДЛИНА"""
        ...
        # 80% шанс добавить дополнительную информацию (увеличиваем для более длинных постов)
    ...
    def convert_to_personal_voice_style(self, text):
        """Конвертирует текст для голосового сообщения - читается 1в1 как текст с добавлением мата"""
    ...
    def generate_voice_message(self, text):
        """Генерирует голосовое сообщение - читается 1в1 как текст с добавлением мата"""
        try:
            ...
            logger.info(f"Текст для озвучки (с матом): {personal_text}")
    ...
    def schedule_messages(self):
        """Планирует отправку сообщений 10 раз в день: 3 с фото, 2 текстовых, 3 голосовых, 2 ответных"""
        # 7:00 утра - ГОЛОСОВОЕ СООБЩЕНИЕ
        schedule.every().day.at("07:00").do(self.send_voice_message_sync)
        # 9:00 утра - СООБЩЕНИЕ С ФОТО
        schedule.every().day.at("09:00").do(self.send_message_with_photos_sync)
        # 11:00 утра - ГОЛОСОВОЕ СООБЩЕНИЕ
        schedule.every().day.at("11:00").do(self.send_voice_message_sync)
        # 13:00 дня - СООБЩЕНИЕ С ФОТО
        schedule.every().day.at("13:00").do(self.send_message_with_photos_sync)
        # 15:00 дня - текстовое
        ...
        # 19:00 вечера - СООБЩЕНИЕ С ФОТО
        schedule.every().day.at("19:00").do(self.send_message_with_photos_sync)
