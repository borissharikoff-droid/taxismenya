...
class WorkBot:
    def __init__(self):
        ...
        self.bonuses = [
            ...
            "в подарок сломанную зубочистку для зубочистки, ебать",
            "в подарок ржавую скрепку для скрепки, бляха-муха",
            "в подарок старую резинку для резинки резинки, епты бля",
            "в подарок пустую коробку от коробки, блядски",
            "в подарок сломанную заколку для заколки заколки, блядь",
            "в подарок ржавую кнопку от кнопки, епта",
            "в подарок старую наклейку с наклейкой, сука",
            "в подарок пустую упаковку от упаковки, бляяя",
            "в подарок сломанную зубочистку для зубочистки зубочистки, ебать",
            "в подарок ржавую скрепку для скрепки скрепки, бляха-муха",
            "в подарок старую резинку для резинки резинки резинки, епты бля",
            "в подарок пустую коробку от коробки коробки, блядски",
            "в подарок сломанную заколку для заколки заколки заколки, блядь",
            "в подарок ржавую кнопку от кнопки кнопки, епта",
            "в подарок старую наклейку с наклейкой наклейкой, сука",
            "в подарок пустую упаковку от упаковки упаковки, бляяя",
            "в подарок сломанную зубочистку для зубочистки зубочистки зубочистки, ебать",
            "в подарок ржавую скрепку для скрепки скрепки скрепки, бляха-муха",
            "в подарок старую резинку для резинки резинки резинки резинки, епты бля",
            "в подарок пустую коробку от коробки коробки коробки, блядски",
            "в подарок сломанную заколку для заколки заколки заколки заколки, блядь",
            "в подарок ржавую кнопку от кнопки кнопки кнопки, епта",
            "в подарок старую наклейку с наклейкой наклейкой наклейкой, сука",
            "в подарок пустую упаковку от упаковки упаковки упаковки, бляяя",
            "в подарок сломанную зубочистку для зубочистки зубочистки зубочистки зубочистки, ебать",
            "в подарок ржавую скрепку для скрепки скрепки скрепки скрепки, бляха-муха",
            "в подарок старую резинку для резинки резинки резинки резинки резинки, епты бля",
            "в подарок пустую коробку от коробки коробки коробки коробки, блядски",
            "в подарок сломанную заколку для заколки заколки заколки заколки заколки, блядь",
            "в подарок ржавую кнопку от кнопки кнопки кнопки кнопки, епта",
            "в подарок старую наклейку с наклейкой наклейкой наклейкой наклейкой, сука",
            "в подарок пустую упаковку от упаковки упаковки упаковки упаковки, бляяя"
        ]
    ...
    def convert_to_personal_voice_style(self, text):
        ...
        # 30% шанс добавить сельское выражение в начало
        if random.random() < 0.3:
            expression = random.choice(rural_expressions)
            result = f"{expression}, {result}"
        
        # 20% шанс добавить сельское выражение в середину
        if random.random() < 0.2:
            expression = random.choice(rural_expressions)
            words = result.split()
            if len(words) > 3:
    ...
    def generate_voice_message(self, text):
        ...
        try:
            ...
            # Добавляем звуковые эффекты (30% шанс)
            if random.random() < 0.3:
                sound_effects = [
                    " *тупит* ", " *рыгает* ", " *пердит* ", " *сморкается* ",
                    " *икает* ", " *кашляет* ", " *чихает* ", " *зевает* ",
