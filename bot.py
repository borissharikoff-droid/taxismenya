...
class WorkBot:
    def __init__(self):
        ...
        self.quirky_additions = [
            "P.S. Забор красить аккуратно, блядь",
            "P.S. Бабушка ворчит но не злая, епты бля",
            "P.S. Крыльцо отмыть до блеска, ебать",
            "P.S. Дом помыть хорошо, бляяя",
            "P.S. Снег убирать осторожно, епта",
            "P.S. Машину помыть до блеска, бляха-муха",
            "P.S. Траву косить ровно, ебать бля",
            "P.S. Стены красить аккуратно, блядски",
            "P.S. Мусор убирать весь, ептыть",
            "P.S. Окна помыть чисто, блядь",
            "P.S. Ворота покрасить хорошо, ебать как",
            "P.S. Листья убрать все, бляяя",
            "P.S. Полы помыть до блеска, епта",
            "P.S. Заборчик покрасить ровно, бляха-муха",
            "P.S. Снег убирать аккуратно, ебать бля",
            "P.S. Посуду помыть чисто, блядски",
            "P.S. Лавочку покрасить хорошо, ептыть",
            "P.S. Мусор убрать весь, блядь",
            "P.S. Двери помыть до блеска, ебать как",
            "P.S. Калитку покрасить ровно, бляяя",
            "P.S. Собака лает но не кусается, епта",
            "P.S. Соседи ворчат но не мешают, бляха-муха",
            "P.S. Работать можно в любое время, ебать бля",
            "P.S. Деньги дам сразу после работы, блядски",
            "P.S. Еще и чай с печеньками, ептыть",
            "P.S. В подарок дам старую отвертку, блядь",
            "P.S. Материалы все есть, ебать как",
            "P.S. Инструменты предоставлю, бляяя",
            "P.S. Опыт не важен, епта",
            "P.S. Главное желание работать, бляха-муха"
        ]
